...
INSERT INTO `ccs` (`ccs`, `ip`, `port`, `dist`, `id`, `server_key`, `memo`) VALUES ('ccs_daili','{{CCS_DAILI_IP}}',8110,'{{ZONE}}',1,'',NULL);
...
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','门派比武大会','三线:金系/三线:木系/二线:水系/二线:火系/三线:土系','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','baishou_shengyan','([\"一线\":({40,79,}),\"一线\":({80,99,}),\"一线\":({100,119,}),\"一线\":({120,159,}),])','','');
...
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','CITY_WAR_SERVER','一线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','dongfu_tiaozhan','一线','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','douchong_dahui','一线','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','试道大会','三线:60-69,70-79,80-89/三线:90-99,100-109,110-119/二线:120-129,130-139,140-149,150-159,160-169','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','fishing_server','({\"一线\",\"二线\" })','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','group_buying_server','一线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','hero_boss_server','一线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','journey_of_asktao','([ \"date\" : \"20160713\", \"checksum\" : \"5FA8074842CF18DF6DDBEEB02BC8E289\" ])','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','ldb_host','127.0.0.1:','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','lgxy_server','一线','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','longxue_boss_server','一线','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','map_decorate_server','一线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','mdb_host','127.0.0.1:','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','party_qkbgz','([4:\"三线\",3:\"二线\",2:\"一线\",])','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','party_qql','一线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','party_sell_servers','一线','',NULL);
...
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','send_exp_online','([\"end_time\":\"2010-06-29-12:00:00\",\"start_time\":\"2010-06-29-10:00:00\",\"interval\":0,\"duration\":0,])','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','shengsidou','1','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','sncbc_open_gs','({\"一线\",\"二线\" })','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','super_boss_server','一线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','task_control_server','一线','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','vendue_place','一线','','NULL');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','WAR_GROUP_A','一线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','WAR_GROUP_B','二线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','WAR_GROUP_C','三线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','wedding_server','一线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','world_boss_server','一线','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','world_level_config','0','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','wuzhuangyuan','一线:60-69,70-79/一线:80-89,90-99/一线:100-109,110-119/一线:120-129,130-139,140-149,150-159,160-169','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','xinfjjwz','([ \"start_time\" : \"2017-07-01-20:00:00\", \"end_time\" : \"2017-08-21-19:59:59\" ])','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','xinfu_chongbang','([ \"start_time\" : \"2016-08-08-00:00:00\", \"end_time\" : \"2016-08-31-23:59:59\", \"bonus_time\" : \"2016-09-06-23:59:59\", \"order_end_time\" : \"2016-09-10-23:59:59\", \"url\" : \"http://wd.gyyx.cn/huodong/wdxf/tf/bwcx/cbbs/index.html\" ])','','');
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','xiygc_zhenyz','({\"一线\"})','','');
...
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','yuqing_shandian_challenge','一线','',NULL);
INSERT INTO `config` (`version`, `dist`, `section`, `name`, `value`, `checksum`, `memo`) VALUES ('','{{ZONE}}','global','比武大会','三线:60-69,70-79/一线:80-89,90-99/二线:100-109,110-119/三线:120-129,130-139,140-149','',NULL);
...
INSERT INTO `csa` (`csa`, `ip`, `port`, `id`, `cs_dist`, `http_ip`, `http_port`, `http_plat`, `httpd_enable`, `memo`) VALUES ('csa_daili','{{CSA_DAILI_IP}}','6101',7,'{{ZONE}}','',0,'',0,'');
...
INSERT INTO `dba` (`dba`, `ip`, `port`, `dist`, `server_key`, `id`, `memo`) VALUES ('dba_daili','{{DBA_DAILI_IP}}',8120,'{{ZONE}}','',1,NULL);
...
INSERT INTO `district` (`dist`, `alias`, `service`, `id`, `spa`, `csa`, `party_war_server`, `memo`) VALUES ('{{ZONE}}','','login/new_char/permit_wizard/new_account/new_party',1,'spa_jiangw','csa_daili','',NULL);
...
INSERT INTO `server` (`server`, `alias`, `ip`, `port`, `max_user`, `dist`, `enable`, `server_key`, `when_iid_duplicated`, `when_challenge_failed`, `when_found_cheater`, `punish_id`, `save_when_coin_cost`, `charge_level`, `charge_interval`, `id`, `ahserver`, `ip_wt`, `ip_dx`, `enable_multi_ip`, `memo`) VALUES ('三线','','118.24.7.124',8162,1200,'{{ZONE}}',1,'','','','',0,0,0,0,3,'','','',0,NULL);
INSERT INTO `server` (`server`, `alias`, `ip`, `port`, `max_user`, `dist`, `enable`, `server_key`, `when_iid_duplicated`, `when_challenge_failed`, `when_found_cheater`, `punish_id`, `save_when_coin_cost`, `charge_level`, `charge_interval`, `id`, `ahserver`, `ip_wt`, `ip_dx`, `enable_multi_ip`, `memo`) VALUES ('一线','','118.24.7.124',8160,1200,'{{ZONE}}',1,'network','','','',0,0,0,600,1,'apex1','','',0,NULL);
INSERT INTO `server` (`server`, `alias`, `ip`, `port`, `max_user`, `dist`, `enable`, `server_key`, `when_iid_duplicated`, `when_challenge_failed`, `when_found_cheater`, `punish_id`, `save_when_coin_cost`, `charge_level`, `charge_interval`, `id`, `ahserver`, `ip_wt`, `ip_dx`, `enable_multi_ip`, `memo`) VALUES ('二线','','118.24.7.124',8161,1200,'{{ZONE}}',1,'','','','',0,0,0,0,2,'','','',0,NULL);
