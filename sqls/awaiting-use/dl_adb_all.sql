...
INSERT INTO `server` (`server`, `alias`, `ip`, `port`, `max_user`, `dist`, `enable`, `server_key`, `when_iid_duplicated`, `when_challenge_failed`, `when_found_cheater`, `punish_id`, `save_when_coin_cost`, `charge_level`, `charge_interval`, `id`, `ahserver`, `ip_wt`, `ip_dx`, `enable_multi_ip`, `memo`) VALUES ('一线','','{{CHANNEL_IP}}',8160,1200,'{{ZONE}}',1,'network','','','',0,0,0,600,1,'apex1','','',0,NULL);
INSERT INTO `server` (`server`, `alias`, `ip`, `port`, `max_user`, `dist`, `enable`, `server_key`, `when_iid_duplicated`, `when_challenge_failed`, `when_found_cheater`, `punish_id`, `save_when_coin_cost`, `charge_level`, `charge_interval`, `id`, `ahserver`, `ip_wt`, `ip_dx`, `enable_multi_ip`, `memo`) VALUES ('二线','','{{CHANNEL_IP}}',8161,1200,'{{ZONE}}',1,'','','','',0,0,0,0,2,'','','',0,NULL);
